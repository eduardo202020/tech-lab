...
export default function SupabaseTest() {
  const { projects, loading: projectsLoading, error: projectsError } = useSupabaseProjects();
  const { researchers, loading: researchersLoading, error: researchersError } = useSupabaseResearchers();
      ...
      <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-300">
            {projectsError || researchersError}
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gray-800 p-6 rounded-lg text-center">
            <h2 className="text-2xl font-bold text-purple-400">{researchers.length}</h2>
        ...
        {/* Proyectos Recientes */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-4 text-blue-400">🚀 Proyectos Recientes</h2>
        ...
        {/* Equipo Tech Lab */}
        <div>
          <h2 className="text-2xl font-bold mb-4 text-purple-400">👥 Equipo Tech Lab</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div key={researcher.id} className="bg-gray-800 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{researcher.position}</p>
                  </div>
                </div>
